...
export const STYLIST_CLOTHES = [
  ...
  { id: 205, name: 'Áo Sơ Mi Oxford Navy Slim-Fit', categoryId: 1, categoryName: 'Tops', price: 349000, priceFormatted: '349K', platform: 'Zara', isAffiliate: false, color: 'Xanh Navy', style: 'Smart Casual', season: 'AllSeason', brand: 'ZARA MAN', imageUrl: '/assets/stylist/navy-shirt-essential.png', description: 'Áo sơ mi dài tay xanh navy phom dáng ôm vừa vặn, chất vải oxford dệt thoáng khí.' },
...
export const INITIAL_OUTFITS_MALE = [
  { id: 301, name: 'Cream & Black Signature', occasion: 'Casual', season: 'AllSeason', isFavorite: true, createdByAi: false, itemIds: [202, 203, 204], description: 'Sweatshirt đen, quần cream và sneaker retro: một set streetwear tối giản.' },
  { id: 302, name: 'Summer Relaxed Street', occasion: 'Casual', season: 'Summer', isFavorite: true, createdByAi: false, itemIds: [201, 203, 204], description: 'Áo ba lỗ màu taupe cùng quần suông cream và sneaker retro mát mẻ ngày hè.' },
  { id: 303, name: 'Smart Casual Navy Look', occasion: 'Formal', season: 'AllSeason', isFavorite: true, createdByAi: false, itemIds: [205, 203, 204], description: 'Áo sơ mi oxford xanh navy kết hợp quần suông màu kem và sneaker retro thanh lịch.' }
];
